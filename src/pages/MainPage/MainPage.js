export default function MainPage() {
    return (
        <div className="section is-small">
            ...
            <section className="container">
            <h2 className="subtitle my-2"><i className="fa-solid fa-circle-check"></i>&nbsp; Getting Started</h2>
            ...
            <section className="container">
                <h2 className="subtitle my-2"><i className="fa-solid fa-circle-check"></i>&nbsp; Add New Meals</h2>
            ...
            <section>
                <h2 className="subtitle my-2"><i className="fa-solid fa-circle-check"></i>&nbsp; List of Meals</h2>
                <p className="my-1">You can view a list of all your meals, update any meal's details, or remove unwanted meals.</p>
            </section>

            <section>
                <h2 className="subtitle my-2"><i className="fa-solid fa-circle-check"></i>&nbsp; Meal Filtering</h2>
            ...
            <section>
                <h2 className="subtitle my-2"><i className="fa-solid fa-circle-check"></i>&nbsp; User Settings</h2>
                <p className="my-1">Set your expected number of calories per day in the user settings.</p>
            </section>

            <section>
                <h2 className="subtitle my-2"><i className="fa-solid fa-circle-check"></i>&nbsp; Color-Coded Meals</h2>
